window.addEventListener('DOMContentLoaded', () => {
    ...
    if (editId !== null) {
        ...
        document.getElementById('matricula').value = alunoParaEditar.numero_de_matricula;
        document.getElementById('data_nascimento').value = alunoParaEditar.data_de_nascimento;
...
function armazenar() {
    ...
    if (editId !== null) {
        ...
        alunoEditado.numero_de_matricula = matricula;
        alunoEditado.data_de_nascimento = data_nascimento;

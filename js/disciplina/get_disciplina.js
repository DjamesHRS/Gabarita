...
async function excluir(id){
    const retorno = await fetch('../../php/disciplina/excluir_disciplina.php?id='+id);
...
async function carregarLista() {
    ...
    if (resposta.status == "ok") {
        ...
        for (var i = 0; i < resposta.data.length; i++) {
            ...
            html += `
                <tr>
                    ...
                    <!-- Botão Alterar -->
                        <a href='alterar_disciplina.html?id=${obj.id}' class="btn gab-btn-primary btn-sm me-2">
        ...
        alert("Erro ao carregar lista de disciplinas! " + resposta.mensagem);
    }
}